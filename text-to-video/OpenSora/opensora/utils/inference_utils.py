...
class GPT4:
    def __init__(self, api_version, api_key, model="gpt-4o"): 
        super().__init__ () 
        self.model = model 
        self.client = openai.AzureOpenAI( 
            ...
            api_key=api_key) 
    def message(self, sys_prompt, content): 
...
def refine_prompt_by_openai(prompt):
    ...
    gpt_handler = GPT4(api_version="gpt-4o-2024-05-13", 
        api_key= 'sFQeUU8UGZ0IGzcHLTMxeHonp7vGJQ8g', # 'O0RToTCQZjbsH6zmvWAD31uXwB6UvYXG', wj. 'sFQeUU8UGZ0IGzcHLTMxeHonp7vGJQ8g', jyt. 'AQ54fWtzKKGTjm64RJZiXx4w65oUrLMi', zjc
        model="gpt-4o-2024-05-13")
    while True:
        try:
            response = gpt_handler.message(sys_prompt=REFINE_PROMPTS, content=prompt) 
            break
